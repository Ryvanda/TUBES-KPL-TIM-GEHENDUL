...
let menus = [
  {
    ...
    desc: "Pedas Sedang, Telur Ceplok",
    cat: "food",
    price: 25000,
    active: true,
  ...
  },
  {
    ...
    desc: "Kuah Bening, Koya Gurih",
    cat: "food",
    price: 18000,
    active: true,
    image: "https://picsum.photos/seed/sotoayam/200/200",
  },
  {
    id: 5,
    name: "Rendang Sapi",
    desc: "Daging Sapi Empuk, Bumbu Padang",
    cat: "food",
    price: 32000,
    active: false,
    image: "https://picsum.photos/seed/rendang/200/200",
  },
  {
    id: 6,
    name: "Gado-gado Jakarta",
    desc: "Sayuran Segar, Bumbu Kacang",
    cat: "food",
    price: 15000,
    active: true,
    image: "https://picsum.photos/seed/gadogado/200/200",
  },
  {
    id: 7,
    name: "Es Teh Manis",
    desc: "Gula Murni, Es Kristal",
    cat: "drink",
    price: 5000,
    active: true,
    image: "./assets/images/es_teh_manis.png",
  },
  {
    id: 8,
    name: "Jus Jeruk Peras",
    desc: "Jeruk Medan Asli, Tanpa Gula",
    cat: "drink",
    price: 15000,
    active: false,
  ...
  },
  {
    id: 9,
    name: "Es Kopi Susu",
    desc: "Kopi Robusta, Susu Segar",
    cat: "drink",
    price: 18000,
    active: true,
    image: "https://picsum.photos/seed/eskopi/200/200",
  },
  {
    id: 10,
    name: "Teh Tarik",
    desc: "Teh Ceylon, Susu Kental Manis",
    cat: "drink",
    price: 12000,
    active: true,
    image: "https://picsum.photos/seed/tehtarik/200/200",
  },
];
...
function renderMenu() {
  ...
  document.getElementById("footInfo").textContent =
    `Menampilkan ${showing} dari ${filtered.length} menu`;
  updateStats();
...
function saveMenu() {
  ...
  const imgToSave =
    currentImageData ||
    `https://picsum.photos/seed/${name.replace(/\s/g, "")}/200/200`;
